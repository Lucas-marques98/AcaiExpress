...
export const products: Product[] = [
  {
    ...
    description: 'Açaí puro e cremoso, batido na hora. Acompanha granola e leite em pó.',
    price: 18.90,
    image: 'https://images.unsplash.com/photo-1590301157890-4810ed352733?q=80&w=800&auto=format&fit=crop',
    status: 'available',
    featured: true,
    variations: [
      { id: 'v1', name: '300ml', price: 14.90 },
      { id: 'v2', name: '500ml', price: 18.90 },
      { id: 'v3', name: '700ml', price: 24.90 },
    ],
    addonGroups: [
      {
        id: 'g1',
        ...
        maxChoices: 2,
        items: [
          { id: 'a1', name: 'Banana', price: 0 },
          { id: 'a2', name: 'Morango', price: 2.50 },
          { id: 'a3', name: 'Manga', price: 0 },
      ...
      },
      {
        ...
        maxChoices: 3,
        items: [
          { id: 'a5', name: 'Granola', price: 0 },
          { id: 'a6', name: 'Leite em Pó', price: 0 },
          { id: 'a7', name: 'Paçoca', price: 0 },
          { id: 'a8', name: 'Amendoim', price: 0 },
        ]
      },
      {
        id: 'g3',
        ...
        maxChoices: 2,
        items: [
          { id: 'a9', name: 'Leite Condensado', price: 1.50 },
          { id: 'a10', name: 'Mel', price: 1.50 },
          { id: 'a11', name: 'Nutella', price: 5.00 },
          { id: 'a12', name: 'Creme de Ninho', price: 4.00 },
        ]
      }
    ]
  },
  {
    id: 'p2',
    categoryId: '2',
    name: 'Monte seu Açaí - Personalizado',
    description: 'Você escolhe tudo! Do tamanho aos complementos mais premium.',
    price: 15.00,
    image: 'https://images.unsplash.com/photo-1590301157461-50942475727b?q=80&w=800&auto=format&fit=crop',
    status: 'available',
    featured: true,
    variations: [
      ...
      { id: 'v7', name: 'Barca Família', price: 45.00 },
    ],
    addonGroups: [
      {
        id: 'g4',
        name: 'Cremes (Escolha 1)',
        minChoices: 1,
        maxChoices: 1,
        items: [
          ...
          { id: 'a16', name: 'Creme de Avelã', price: 2.00 },
        ]
      },
      {
        id: 'g5',
  ...
  },
  {
    ...
    description: '2 Açaís de 500ml com 3 complementos cada + 1 adicional de Nutella grátis.',
    price: 39.90,
  ...
  },
  {
    ...
    description: 'Super cremoso, batido com leite e sorvete de baunilha.',
    price: 16.00,
...
export const storeConfig: StoreConfig = {
  ...
  banner: 'https://images.unsplash.com/photo-1590301157890-4810ed352733?q=80&w=1920&auto=format&fit=crop',
